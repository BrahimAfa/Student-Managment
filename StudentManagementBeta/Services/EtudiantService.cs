...
namespace StudentManagementBeta.Services
{
      class EtudiantService : IDAO<EtudiantModel>
      {
            ...
            {
                    SqlCommand cmd = new SqlCommand("SELECT e.ID_Etudiant, e.CNE,e.FirstName,e.LastName,e.gender,e.DOB,e.adresse,e.tele,f.FiliereName from Etudiant e,Filiere f where e.ID_Filiere=f.ID_Filiere;", Connection.sqlConnection);
                    Connection.open();
